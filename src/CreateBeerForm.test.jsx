...
describe('function CreateBeerForm', () => {
    it('children should be properly orderly', () => {        
        ...
        expect(wrapper.childAt(0).type()).toEqual(CreateBeerFormInputText);
        expect(wrapper.childAt(1).type()).toEqual(CreateBeerFormCombobox);
        expect(wrapper.childAt(2).type()).toEqual(CreateBeerFormCheckbox);
        expect(wrapper.childAt(3).type()).toEqual(CreateBeerFormTextArea);
